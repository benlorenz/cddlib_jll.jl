# Autogenerated wrapper script for cddlib_jll for x86_64-apple-darwin14
export libcddgmp
...
const libcddgmp_splitpath = ["lib", "libcddgmp.0.dylib"]
...
const libcddgmp = "@rpath/libcddgmp.0.dylib"
