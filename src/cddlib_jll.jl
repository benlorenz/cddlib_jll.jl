...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import cddlib_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f07e07eb-5685-515a-97c8-3014f6152feb"))
platforms = [Pkg.Artifacts.unpack_platform(e, "cddlib", artifacts_toml) for e in artifacts["cddlib"]]
...
if best_platform === nothing
    @debug("Unable to load cddlib; unsupported platform $(triplet(platform_key_abi()))")
else
